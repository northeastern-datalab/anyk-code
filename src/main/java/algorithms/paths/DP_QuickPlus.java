...
/** 
 * QuickMemoized is a variant of Anyk-PartMemoized that implements {@link #get_successors} 
...
*/
public class DP_QuickPlus extends DP_PartPlus
{
	public DP_QuickPlus(DP_Problem_Instance inst, Configuration conf)
    {
    	super(inst, conf);
    }
